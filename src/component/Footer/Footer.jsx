...
const CATEGORY_LINKS = [
  { to: "/blog?category=إضاءة", label: "إضاءة" },
  { to: "/blog?category=بورتريه", label: "بورتريه" },
  { to: "/blog?category=مناظر طبيعية", label: "مناظر طبيعية" },
  { to: "/blog?category=تقنيات", label: "تقنيات" },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-neutral-600">
              © 2026 عدسة. صنع بكل <i className="fa-solid fa-heart text-orange-500" /> جميع الحقوق محفوظة.
            </p>
